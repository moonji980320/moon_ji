  			...
  			<form>
  				...
  				<div class="form-group">
  					<input type="text" class="form-control" placeholder="아이디" width="70%" name="name" id="userID">
  					  ...
  					  <div class="wrap">
        <input type="button" class="checkbutton" onclick="mycheck()" value="중복확인">
      </div>
  				</div>
  				<div class="form-group">
  		...
  		<input type="button" class="btn btn-primary form-control" style="width:47%; background-color: #3c4245" onclick="add()" value="회원가입">
